...
export default function SectionTitle({ text1, text2, text3 }: SectionTitleProps) {
    return (
        <>
            <motion.p className="text-center font-medium text-[var(--color-primary)] mt-28 px-10 py-2 rounded-full bg-[rgba(157,205,90,0.7)] border border-[var(--color-primary-active)] w-max mx-auto"
