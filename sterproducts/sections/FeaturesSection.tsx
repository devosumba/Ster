        ...
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 px-6">
                {featuresData.map((feature: IFeature, index: number) => (
                    <motion.div key={index} className={`${index === 1 ? 'p-px rounded-[13px] bg-linear-to-br from-[var(--color-primary)] to-slate-800' : ''}`}
                ...
                <div className="absolute -z-50 size-100 -top-10 -left-20 aspect-square rounded-full bg-[rgba(157,205,90,0.4)] blur-3xl"></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <a href="#!" className="group flex items-center gap-2 mt-4 text-[var(--color-primary)] hover:text-[var(--color-primary-hover)] transition">
